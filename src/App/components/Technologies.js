...
export default function Tech() {
  return (
    <>
    <div className="fullPage-2" id="technologiesPage">
      <h4>Technologies</h4>
      <div id="technologies">
        <img className= "tech-logo" src="https://cdn.shortpixel.ai/client/q_glossy,ret_img,w_512/https://robcolecreative.com/wp-content/uploads/2021/03/html-1.png"/>
        <img className= "tech-logo" src="https://cdn.shortpixel.ai/client/q_glossy,ret_img,w_512/https://robcolecreative.com/wp-content/uploads/2021/03/css.png"/>
        <img className= "tech-logo" src="https://cdn.shortpixel.ai/client/q_glossy,ret_img,w_512/https://robcolecreative.com/wp-content/uploads/2021/03/js.png"/>
